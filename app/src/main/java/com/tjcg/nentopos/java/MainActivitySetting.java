...
public class MainActivitySetting extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_time=i.getStringExtra("order_time");
...
//                startActivity(intent);
    ...
    private void connectBT(){
        ...
        if (BtAdress.equals(null)||BtAdress.equals("")){
            ...
            SharedPreferences.Editor editor = getSharedPreferences("com.tjcg.nentopos", MODE_PRIVATE).edit();
            editor.putString("address", BtAdress.toString());
            editor.commit();
            Toast.makeText(getApplicationContext(),"Printer setting successfull ! click on print  ", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(MainActivitySetting.this,MainActivity.class);
            startActivity(i);
...
//                    ISCONNECT=true;
//
//                        Intent intent = new Intent(getApplicationContext(), R80Activity.class);
//                        intent.putExtra("o_id",o_id);
//                        intent.putExtra("cust_name",cust_name);
//                        intent.putExtra("order_date",order_date);
//                        intent.putExtra("order_time",order_time);
